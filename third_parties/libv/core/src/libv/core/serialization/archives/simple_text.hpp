...
#ifndef LIBV_CORE_SERIALIZATION_ARCHIVES_SIMPLE_TEXT_HPP
#define LIBV_CORE_SERIALIZATION_ARCHIVES_SIMPLE_TEXT_HPP
...
*/
struct LIBV_CORE_EXPORT SimpleTextInputArchive
: InputArchive
{
  SimpleTextInputArchive(std::istream &);
private:
...
*/
struct LIBV_CORE_EXPORT SimpleTextOutputArchive
: OutputArchive
{
  SimpleTextOutputArchive(std::ostream &);
private:
